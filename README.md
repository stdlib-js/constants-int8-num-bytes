...
```javascript
INT8_NUM_BYTES = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int8-num-bytes@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-int8-num-bytes@v0.2.1-umd/browser.js"></script>
```
